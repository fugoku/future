...
export default function AppLayout({
  ...
  // useEffect(() => {
  //   Crisp.configure("2c09b1ee-14c2-bf72", {
  //     autoload: false,
  //   });
  // }, []);
  ...
  //   }
  // }, [error, session, router.asPath, loading, setShowAcceptInviteModal, setShowGoogleOauthModal]);
  ...
  return (
    <div>
      ...
      >
        <div className="sticky inset-x-0 top-0 z-20 border-b border-gray-200 bg-white">
          <MaxWidthWrapper>
            <div className="flex h-16 items-center justify-between">
              <div className="flex items-center">
                <Link href="/">
                  {/* <Logo className="h-8 w-8 transition-all duration-75 active:scale-95" /> */}
                  <Icons.logo className="h-8 w-8 transition-all duration-75 active:scale-95" />
                </Link>
